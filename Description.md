...
[Bhattacharya et al](https://arxiv.org/abs/1705.03088 "Shrijita's paper"). The data are merely 
...
estimator introduced in [Bhattacharya et al](https://arxiv.org/abs/1705.03088 "Shrijita's paper") provides
...
In the side bar, one can choose from three different categories of data. The first of them is the Simulated Data set where observations can be drawn from either Pareto, Burr, Frechet and |T| distribution. The outliers are injected according to Relation 4.4 in [Bhattacharya et al](https://arxiv.org/abs/1705.03088 "Shrijita's paper"). One can also control for the tail index (xi), number of injected outliers (k0_outliers) and magnitude of the outliers (L).
